...
import org.osate.xtext.aadl2.errormodel.preferences.EMV2Plugin
import org.osate.xtext.aadl2.errormodel.preferences.Constants
import org.osate.xtext.aadl2.errormodel.errorModel.EMV2Package

@RunWith(XtextRunner)
@InjectWith(ErrorModelUiInjectorProvider)
class ErrorTypesTestSeparateSubclause extends OsateTest {
	/*
	...
	def void testErrorTypesReference() {
		val store = EMV2Plugin.getDefault().getPreferenceStore();
		store.setDefault(Constants.EMV2_SEPARATE_FILE, Constants.EMV2_SEPARATE_FILE_YES);

		val lib1FileName = "lib1.emv2"
		val lib2FileName = "lib2.emv2"
		val lib3FileName = "lib3.emv2"
		val lib4FileName = "lib4.emv2"
		val lib5FileName = "lib5.emv2"
		val lib6FileName = "lib6.emv2"
		val subclause1FileName = "subclause1.emv2"
		val classifier1FileName = "subclause1.aadl"
		...
		val classifier1TestResult = testFile(classifier1FileName)
		val subclause1TestResult = testFile(subclause1FileName)
		lib1TestResult.resource.contents.head as ErrorModelLibrary => [
		...
		lib2TestResult.resource.contents.head as ErrorModelLibrary => [
		...
		lib3TestResult.resource.contents.head as ErrorModelLibrary => [
		...
		lib4TestResult.resource.contents.head as ErrorModelLibrary => [
		...
		lib6TestResult.resource.contents.head as ErrorModelLibrary => [
